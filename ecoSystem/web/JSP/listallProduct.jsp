<%-- 
    ...
    Created on : Oct 28, 2022, 11:41:37 PM
    Author     : Asus
--%>
                            ...
                            <div class="item">
                                <div class="thumb">
                                    <div class="hover-content">
                                        <ul>
                                            <li><a href="DetailController"><i class="fa fa-eye"></i></a></li>                                            
                                            <li><a href="CartController?id=${p.product_id}"><i class="fa fa-shopping-cart"></i></a></li>
                                        </ul>
                                    </div>
                                    <img src="${p.img}" alt="" style="height: 265px">
                                </div>
                        ...
                        <div class="pagination">
                            <ul>
                                <c:forEach begin="1" end="${endP}" var="i">
                                    <li>
                                        <a class="${tag == i?"active":""}" href="ProductController?index=${i}">${i}</a>
                                    </li>
                                </c:forEach>
                            </ul>
