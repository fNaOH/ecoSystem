                    ...
                    <div class="card-wrapper">
                        ...
                        <div class="card fat">
                            <div class="card-body">
                                ...
                                <form action="RegisterController" method="POST" class="my-login-validation" novalidate="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="re-password" type="re-password" class="form-control" name="re-password" required data-eye>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="mt-4 text-center">
                                        Already have an account? <a href="LoginController">Login</a>
                                    </div>
                                </form>
                            </div>
                        </div>
